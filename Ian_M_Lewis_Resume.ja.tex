...
クラウドネイティブインフラストラクチャ、ディフェンシブセキュリティ、デベロッパーエクスペリエンスの分野で20年以上の開発経験を持つエンジニアリングリーダーです。2006年から日本に在住し、「ソフトウェアは誰もがアクセスできるべきである」という信念を持っています。メンターシップ、教育、そして誰もが歓迎されるインクルーシブなエンジニアリング文化の醸成に情熱を注いでいます。技術力の高いグローバル企業において、影響力の大きいプロジェクトへ貢献することを希望しています。
...
\begin{list}{}{
    ...
    \begin{itemize}
        ...
        \item \textbf{Supply-chain Levels for Software Artifacts (SLSA)} --- \emph{ソフトウェアエンジニア}\\
            ...
            SLSAは、ソフトウェアサプライチェーン攻撃からソフトウェアを保護するためのベストプラクティスと管理策を提供するフレームワークです。GitHub Actions向けの、npmパッケージおよび汎用アーティファクトの来歴（Provenance）を生成・検証するオープンソースツールの開発を担当しました。
        ...
        \begin{itemize}
            ...
            \item SLSAに対応したGitHub Actions向けのNode.js CIビルダー\footnote{https://github.com/slsa-framework/slsa-github-generator/}を開発し、GitHub・npmの開発者との連携のもと、公式npmレジストリに統合しました。
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            %     RequireJS.
            \item Backbone.js, CoffeeScript, RequireJSを使用した軽量モジュラーフロントエンドアーキテクチャを設計・実装しました。
    ...
    % of sale systems for hair salons and pharmacies.
        株式会社シンクは、ヘアサロンや薬局向けのPOS（Point of Sale）システムの開発を専門とする日本のソフトウェア開発会社です。
