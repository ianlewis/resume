...
\begingroup
    \parbox[t]{.6\textwidth}{
        ...
        \textbf{英語:} ネイティブ\\
            ...
            \hspace{2.2cm}J.TEST実用日本語検定 CEFR C1 --- 2025年取得）
        \end{flushleft}
    }\hfill%
    \parbox[t]{.4\textwidth}{
        \begin{flushright}
...
\begin{list}{}{
    ...
    \item \textbf{\large ソフトウェアエンジニア} --- \emph{株式会社ビープラウド、東京、日本 (2008年--2014年)}
    ...
    \budoux{ビープラウドは、Webアプリケーションとクラウドサービスの開発を専門とする日本のソフトウェア開発会社です。自社サービスの開発、社内インフラの開発・保守、そしてDeNA、サイバーエージェント、楽天、ECナビ、日経BPなどの顧客プロジェクト開発を担当しました。}
